...
def roc_curve(TPRs, FPRs):
    ...
    **Applications:**
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from causalentropy.core.plotting import roc_curve
    >>> 
    ...
    See Also
    --------
    causalentropy.core.stats.auc : Compute area under ROC curve
    causalentropy.core.stats.Compute_TPR_FPR : Compute TPR and FPR from confusion matrix
    """
    plt.plot(FPRs, TPRs)
    ...
    AUC = auc(TPRs, FPRs)
    plt.text(0.4, 0.1, f'AUC = {AUC:.4f}', fontsize=12, 
