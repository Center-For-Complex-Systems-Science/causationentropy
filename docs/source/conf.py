...
try:
    ...
    print(
        "sphinx_autodoc_typehints not available - install with: pip install sphinx-autodoc-typehints"
    )
...
try:
    ...
    print(
        "sphinx_copybutton not available - install with: pip install sphinx-copybutton"
    )
...
man_pages = [
    ("index", "causationentropy", "Causation Entropy Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "CausationEntropy",
        "Library for causation entropy analysis.",
        "Miscellaneous",
    ),
]
